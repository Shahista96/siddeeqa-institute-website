...
export class MadrasahComponent {
  ...
  openPdf(pdf:string): void {
    ...
    }else if(pdf === 'Tarawih_UR'){
      window.open('../../../assets/PDFs/Tarawih_UR.pdf', '_blank'); // Change 'your-pdf-file.pdf' to your actual PDF file name
    }else if(pdf === 'Zakat_UR'){
      window.open('../../../assets/PDFs/Zakaat_UR.pdf', '_blank'); // Change 'your-pdf-file.pdf' to your actual PDF file name
    }
  }
